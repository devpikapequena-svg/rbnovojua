...
export default function SucessPage() {
  ...
  // opcional: pegar info via querystring (ex: ?order=123&produto=Robux&valor=19.90)
  const orderId = searchParams.get("order") || "";
  const produto = searchParams.get("produto") || "Robux";
  const valor = searchParams.get("valor") || ""; // "19.90"
  ...
  return (
    <div className="sucess-root">
      {/* Mantém sua conversão (se quiser, complete o AW-) */}
